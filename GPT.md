...
The skill contract is located at: `.gpt/skills/frontend-development/SKILL.md`
...
Before generating any UI component, GPT MUST emit a `<design_intent>` block in the conversation. This block is **ephemeral** (conversation-only) and MUST NEVER be committed to the codebase.
...
The skill contract is located at: `.gpt/skills/seo/SKILL.md`
...
- **Forbidden in PR Title/Body:**
  - "Generated by", "AI assisted", "GPT", "LLM"
...
Before creating a PR, GPT MUST verify:
